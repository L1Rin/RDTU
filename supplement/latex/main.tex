...
\clearpage
\FloatBarrier\needspace{10\baselineskip}\input{sections/1_intro}
\FloatBarrier\needspace{10\baselineskip}\input{sections/2_background}
\FloatBarrier\needspace{10\baselineskip}\input{sections/3_methodology}
\FloatBarrier\needspace{10\baselineskip}\input{sections/4_experiment}
\FloatBarrier\needspace{10\baselineskip}\input{sections/5_conclusion}
\appendix
\FloatBarrier\needspace{10\baselineskip}\input{sections/appendix/appendix A}
\FloatBarrier\needspace{10\baselineskip}\input{sections/appendix/appendix B}
\FloatBarrier\needspace{10\baselineskip}\input{sections/appendix/appendix C}
\FloatBarrier\needspace{10\baselineskip}\input{sections/appendix/appendix D}
\FloatBarrier\needspace{10\baselineskip}\input{sections/appendix/appendix E}
\FloatBarrier\needspace{10\baselineskip}\input{sections/appendix/appendix F}
\FloatBarrier\needspace{10\baselineskip}\input{sections/appendix/appendix G}
